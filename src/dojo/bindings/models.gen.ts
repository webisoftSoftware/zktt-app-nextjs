...
export const schema: ZkttSchemaType = {
	zktt: {
		...
		ActionFiftyOnePercentAttack: {
			...
			m_owner: "",
			m_set: [{ fieldOrder: ['m_name', 'm_bc_type', 'm_fee', 'm_value'], m_name: "", m_bc_type: EnumBlockchainType.Blue, m_fee: 0, m_value: 0, }],
			m_value: 0,
			m_index: 0,
		},
		ActionClaimYield: {
		...
		ActionGasFee: {
			...
			m_set_applied: [{ fieldOrder: ['m_name', 'm_bc_type', 'm_fee', 'm_value'], m_name: "", m_bc_type: EnumBlockchainType.Blue, m_fee: 0, m_value: 0, }],
			m_value: 0,
			m_index: 0,
		},
		ActionChainReorg: {
